...
<div class="row gy-4 justify-content-center">
    <div class="col-12 col-lg-8">
        ...
        <h4 class="fw-bold mb-3">Edit Floor: {{ $floor->name }}</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="floor_number" name="floor_number"
                                value="{{ old('floor_number', $floor->floor_number) }}" required min="0">
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="total_units" name="total_units"
                            value="{{ old('total_units', $floor->total_units) }}" min="0">
                    </div>
                    <div class="mb-3">
                        <label for="description" class="form-label">Description</label>
                        <textarea class="form-control" id="description" name="description"
                            rows="2">{{ old('description', $floor->description) }}</textarea>
                    </div>

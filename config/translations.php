...
return [
    ...
    */
    'nav' => [
        ...
        'company_info'  => ['bn' => 'কোম্পানি তথ্য', 'en' => 'Company Info'],
        'website'       => ['bn' => 'ওয়েবসাইট', 'en' => 'Website'],
        'profile_password_hint' => ['bn' => 'পাসওয়ার্ড পরিবর্তন করতে চাইলে নিচে লিখুন (না চাইলে ফাঁকা রাখুন)', 'en' => 'Leave blank if you don\'t want to change password'],
    ...
    */
    'auth' => [
        ...
        'logout'           => ['bn' => 'লগ আউট', 'en' => 'Log Out'],
        'email_or_mobile'  => ['bn' => 'ইমেইল অথবা মোবাইল', 'en' => 'Email or Mobile'],
        'email'            => ['bn' => 'ইমেইল', 'en' => 'Email'],
        ...
        'current_password_wrong' => ['bn' => 'বর্তমান পাসওয়ার্ড সঠিক নয়।', 'en' => 'Current password is incorrect.'],
        ...
        'invalid_credentials' => ['bn' => 'তথ্য সঠিক নয়।', 'en' => 'Invalid credentials.'],
    ],
    ...
    */
    'msg' => [
        ...
        'company_updated'    => ['bn' => 'কোম্পানি তথ্য আপডেট করা হয়েছে।', 'en' => 'Company info updated.'],
    ...
    */
    'property_landing' => [
        // Nav
        'brand'             => ['bn' => 'হিসাবিজ প্রপার্টি', 'en' => 'Hishabiz Property'],
        'nav_features'      => ['bn' => 'ফিচার', 'en' => 'Features'],
        'nav_pricing'       => ['bn' => 'মূল্য', 'en' => 'Pricing'],
        'nav_faq'           => ['bn' => 'জিজ্ঞাসা', 'en' => 'FAQ'],
        'nav_login'         => ['bn' => 'লগইন', 'en' => 'Login'],
        'nav_start_free'    => ['bn' => 'ফ্রি শুরু করুন', 'en' => 'Start Free'],
        'nav_dashboard'     => ['bn' => 'ড্যাশবোর্ড', 'en' => 'Dashboard'],
        'lang_switch'       => ['bn' => 'EN', 'en' => 'বাং'],

        // Hero
        'hero_badge'        => ['bn' => 'বাংলাদেশের #১ প্রপার্টি সফটওয়্যার', 'en' => '#1 Property Software in Bangladesh'],
        'hero_title_pre'    => ['bn' => 'আপনার ', 'en' => 'Your '],
        'hero_title_highlight' => ['bn' => 'রিয়েল এস্টেট', 'en' => 'Real Estate'],
        'hero_title_post'   => ['bn' => ' ব্যবসা এখন সম্পূর্ণ ডিজিটাল', 'en' => ' Business, Fully Digital'],
        'hero_sub'          => ['bn' => 'প্রজেক্ট, বিল্ডিং, ফ্লোর, ইউনিট, বিনিয়োগকারী, গ্রাহক — সবকিছু এক ড্যাশবোর্ডে। সহজে পরিচালনা করুন, দ্রুত সিদ্ধান্ত নিন।', 'en' => 'Projects, buildings, floors, units, investors, customers — everything in one dashboard. Manage easily, decide faster.'],
        'hero_cta'          => ['bn' => 'ফ্রি শুরু করুন', 'en' => 'Start For Free'],
        'hero_login'        => ['bn' => 'লগইন', 'en' => 'Login'],
        'hero_go_dashboard' => ['bn' => 'ড্যাশবোর্ডে যান', 'en' => 'Go to Dashboard'],
        'stat_companies'    => ['bn' => '৫০০+', 'en' => '500+'],
        'stat_companies_label' => ['bn' => 'সক্রিয় কোম্পানি', 'en' => 'Active Companies'],
        'stat_units'        => ['bn' => '১২,০০০+', 'en' => '12,000+'],
        'stat_units_label'  => ['bn' => 'ইউনিট পরিচালিত', 'en' => 'Units Managed'],
        'stat_uptime'       => ['bn' => '৯৯.৯%', 'en' => '99.9%'],
        'stat_uptime_label' => ['bn' => 'আপটাইম', 'en' => 'Uptime'],
        'dashboard_preview' => ['bn' => 'ড্যাশবোর্ড প্রিভিউ', 'en' => 'Dashboard Preview'],

        // Features
        'features_tag'      => ['bn' => 'ফিচারসমূহ', 'en' => 'Features'],
        'features_title'    => ['bn' => 'সব কিছু এক প্ল্যাটফর্মে', 'en' => 'Everything in One Platform'],
        'features_sub'      => ['bn' => 'প্রপার্টি ব্যবসা পরিচালনার জন্য যা যা দরকার, সব এখানে।', 'en' => 'Everything you need to manage your property business.'],
        'feat_project_title' => ['bn' => 'প্রজেক্ট ম্যানেজমেন্ট', 'en' => 'Project Management'],
        'feat_project_desc' => ['bn' => 'একাধিক প্রজেক্ট তৈরি, ট্র্যাক ও পরিচালনা করুন। বাজেট, টাইমলাইন, স্ট্যাটাস সব দেখুন এক জায়গায়।', 'en' => 'Create, track, and manage multiple projects. View budgets, timelines, and status all in one place.'],
        'feat_building_title' => ['bn' => 'বিল্ডিং ও ফ্লোর', 'en' => 'Buildings & Floors'],
        'feat_building_desc' => ['bn' => 'প্রতিটি প্রজেক্টে বিল্ডিং, ফ্লোর, এবং ইউনিট যোগ করুন। হায়ারার্কি মেইনটেইন করুন সহজে।', 'en' => 'Add buildings, floors, and units to each project. Maintain hierarchy effortlessly.'],
        'feat_unit_title'   => ['bn' => 'ইউনিট ট্র্যাকিং', 'en' => 'Unit Tracking'],
        'feat_unit_desc'    => ['bn' => 'প্রতিটি ইউনিটের সাইজ, দাম, স্ট্যাটাস (Available, Booked, Sold) ট্র্যাক করুন রিয়েল-টাইমে।', 'en' => 'Track each unit size, price, and status (Available, Booked, Sold) in real-time.'],
        'feat_investor_title' => ['bn' => 'বিনিয়োগকারী ব্যবস্থাপনা', 'en' => 'Investor Management'],
        'feat_investor_desc' => ['bn' => 'প্রজেক্টভিত্তিক বিনিয়োগকারী, বিনিয়োগের পরিমাণ, শেয়ার পার্সেন্টেজ সহজেই পরিচালনা করুন।', 'en' => 'Manage project-based investors, investment amounts, and share percentages easily.'],
        'feat_customer_title' => ['bn' => 'গ্রাহক ডেটাবেজ', 'en' => 'Customer Database'],
        'feat_customer_desc' => ['bn' => 'সব গ্রাহকের তথ্য, ক্রেডিট লিমিট, যোগাযোগ সংরক্ষণ করুন। Individual ও Business দুই ধরনেই।', 'en' => 'Store all customer info, credit limits, contacts. Supports both Individual and Business types.'],
        'feat_document_title' => ['bn' => 'ডকুমেন্ট ম্যানেজমেন্ট', 'en' => 'Document Management'],
        'feat_document_desc' => ['bn' => 'ফোল্ডার, ক্যাটাগরি ভিত্তিক ডকুমেন্ট আপলোড ও ভার্সন কন্ট্রোল। প্রতিটি এন্টিটির সাথে সংযুক্ত।', 'en' => 'Upload documents with folder/category structure and version control. Attach to any entity.'],

        // How it works
        'how_tag'           => ['bn' => 'কিভাবে কাজ করে', 'en' => 'How It Works'],
        'how_title'         => ['bn' => '৩ ধাপে শুরু করুন', 'en' => 'Get Started in 3 Steps'],
        'how_sub'           => ['bn' => 'মাত্র কয়েক মিনিটে আপনার প্রপার্টি ব্যবসা ডিজিটাল করুন।', 'en' => 'Digitize your property business in just a few minutes.'],
        'step1_title'       => ['bn' => 'অ্যাকাউন্ট তৈরি করুন', 'en' => 'Create Account'],
        'step1_desc'        => ['bn' => 'ফ্রি রেজিস্ট্রেশন করুন। কোনো ক্রেডিট কার্ড লাগবে না।', 'en' => 'Register for free. No credit card required.'],
        'step2_title'       => ['bn' => 'কোম্পানি ও প্রজেক্ট সেটআপ', 'en' => 'Setup Company & Project'],
        'step2_desc'        => ['bn' => 'আপনার কোম্পানি তৈরি করুন, প্রজেক্ট যোগ করুন, বিল্ডিং ও ইউনিট সেটআপ করুন।', 'en' => 'Create your company, add projects, setup buildings & units.'],
        'step3_title'       => ['bn' => 'ব্যবসা পরিচালনা শুরু', 'en' => 'Start Managing'],
        'step3_desc'        => ['bn' => 'গ্রাহক, বিনিয়োগকারী, বিক্রয় সব ট্র্যাক করুন এক ড্যাশবোর্ড থেকে।', 'en' => 'Track customers, investors, sales — all from one dashboard.'],

        // Stats
        'stats_companies'       => ['bn' => '৫০০+', 'en' => '500+'],
        'stats_companies_label' => ['bn' => 'সক্রিয় কোম্পানি', 'en' => 'Active Companies'],
        'stats_projects'        => ['bn' => '২,৫০০+', 'en' => '2,500+'],
        'stats_projects_label'  => ['bn' => 'প্রজেক্ট পরিচালিত', 'en' => 'Projects Managed'],
        'stats_units'           => ['bn' => '১২,০০০+', 'en' => '12,000+'],
        'stats_units_label'     => ['bn' => 'ইউনিট ট্র্যাকিং', 'en' => 'Units Tracked'],
        'stats_value'           => ['bn' => '৳৫০০ কোটি+', 'en' => '৳500 Cr+'],
        'stats_value_label'     => ['bn' => 'সম্পত্তি মূল্য পরিচালিত', 'en' => 'Property Value Managed'],

        // Pricing
        'pricing_tag'       => ['bn' => 'মূল্য পরিকল্পনা', 'en' => 'Pricing Plans'],
        'pricing_title'     => ['bn' => 'আপনার প্রয়োজন অনুযায়ী প্ল্যান বেছে নিন', 'en' => 'Choose the Plan That Fits You'],
        'pricing_sub'       => ['bn' => 'ফ্রি দিয়ে শুরু করুন, যখন বাড়বে তখন আপগ্রেড করুন।', 'en' => 'Start free, upgrade when you grow.'],
        'plan_free'         => ['bn' => 'ফ্রি', 'en' => 'Free'],
        'plan_free_price'   => ['bn' => '৳০', 'en' => '৳0'],
        'plan_per_month'    => ['bn' => 'মাস', 'en' => 'mo'],
        'plan_free_desc'    => ['bn' => 'ছোট ব্যবসার জন্য পারফেক্ট। সব বেসিক ফিচার ফ্রিতে।', 'en' => 'Perfect for small businesses. All basic features free.'],
        'plan_1_company'    => ['bn' => '১টি কোম্পানি', 'en' => '1 Company'],
        'plan_2_projects'   => ['bn' => '২টি প্রজেক্ট', 'en' => '2 Projects'],
        'plan_50_units'     => ['bn' => '৫০টি ইউনিট', 'en' => '50 Units'],
        'plan_3_members'    => ['bn' => '৩ জন টিম মেম্বার', 'en' => '3 Team Members'],
        'plan_basic_reports' => ['bn' => 'বেসিক রিপোর্ট', 'en' => 'Basic Reports'],
        'plan_doc_mgmt'     => ['bn' => 'ডকুমেন্ট ম্যানেজমেন্ট', 'en' => 'Document Management'],
        'plan_api'          => ['bn' => 'API অ্যাক্সেস', 'en' => 'API Access'],
        'plan_start_free'   => ['bn' => 'ফ্রি শুরু করুন', 'en' => 'Start Free'],
        'plan_popular'      => ['bn' => 'জনপ্রিয়', 'en' => 'Popular'],
        'plan_pro'          => ['bn' => 'প্রো', 'en' => 'Pro'],
        'plan_pro_price'    => ['bn' => '৳৯৯৯', 'en' => '৳999'],
        'plan_pro_desc'     => ['bn' => 'বাড়তি ব্যবসার জন্য। সব ফিচার আনলিমিটেড।', 'en' => 'For growing businesses. All features unlimited.'],
        'plan_5_companies'  => ['bn' => '৫টি কোম্পানি', 'en' => '5 Companies'],
        'plan_unlimited_projects' => ['bn' => 'আনলিমিটেড প্রজেক্ট', 'en' => 'Unlimited Projects'],
        'plan_unlimited_units' => ['bn' => 'আনলিমিটেড ইউনিট', 'en' => 'Unlimited Units'],
        'plan_15_members'   => ['bn' => '১৫ জন টিম মেম্বার', 'en' => '15 Team Members'],
        'plan_adv_reports'  => ['bn' => 'অ্যাডভান্সড রিপোর্ট', 'en' => 'Advanced Reports'],
        'plan_email_support' => ['bn' => 'ইমেইল সাপোর্ট', 'en' => 'Email Support'],
        'plan_get_pro'      => ['bn' => 'প্রো নিন', 'en' => 'Get Pro'],
        'plan_enterprise'   => ['bn' => 'এন্টারপ্রাইজ', 'en' => 'Enterprise'],
        'plan_ent_price'    => ['bn' => '৳২,৯৯৯', 'en' => '৳2,999'],
        'plan_ent_desc'     => ['bn' => 'বড় প্রতিষ্ঠানের জন্য কাস্টম সলিউশন।', 'en' => 'Custom solution for large organizations.'],
        'plan_unlimited_companies' => ['bn' => 'আনলিমিটেড কোম্পানি', 'en' => 'Unlimited Companies'],
        'plan_unlimited_all' => ['bn' => 'আনলিমিটেড সবকিছু', 'en' => 'Unlimited Everything'],
        'plan_unlimited_members' => ['bn' => 'আনলিমিটেড টিম মেম্বার', 'en' => 'Unlimited Team Members'],
        'plan_branding'     => ['bn' => 'কাস্টম ব্র্যান্ডিং', 'en' => 'Custom Branding'],
        'plan_dedicated_support' => ['bn' => 'ডেডিকেটেড সাপোর্ট', 'en' => 'Dedicated Support'],
        'plan_sla'          => ['bn' => 'SLA গ্যারান্টি', 'en' => 'SLA Guarantee'],
        'plan_contact'      => ['bn' => 'যোগাযোগ করুন', 'en' => 'Contact Us'],

        // Testimonials
        'testimonials_tag'  => ['bn' => 'গ্রাহকদের মতামত', 'en' => 'Testimonials'],
        'testimonials_title' => ['bn' => 'তারা কি বলছেন', 'en' => 'What They Say'],
        'testimonials_sub'  => ['bn' => 'বাংলাদেশের শত শত প্রপার্টি ব্যবসা আমাদের ব্যবহার করছে।', 'en' => 'Hundreds of property businesses in Bangladesh trust us.'],
        'testimonial_1_text' => ['bn' => 'হিসাবিজ প্রপার্টি আমাদের পুরো ব্যবসাকে ডিজিটাল করেছে। আগে এক্সেলে হিসাব রাখতাম, এখন সব অটোমেটিক।', 'en' => 'Hishabiz Property digitized our entire business. We used to track in Excel, now everything is automated.'],
        'testimonial_1_name' => ['bn' => 'মো. রহিম আহমেদ', 'en' => 'Rahim Ahmed'],
        'testimonial_1_role' => ['bn' => 'MD, রহিম কনস্ট্রাকশন', 'en' => 'MD, Rahim Construction'],
        'testimonial_1_avatar' => ['bn' => 'র', 'en' => 'R'],
        'testimonial_2_text' => ['bn' => 'বিনিয়োগকারীদের তথ্য এবং ইউনিটের স্ট্যাটাস এখন ফোন থেকেই দেখতে পারি। অসাধারণ সফটওয়্যার!', 'en' => 'I can now check investor info and unit status from my phone. Amazing software!'],
        'testimonial_2_name' => ['bn' => 'ফাতিমা বেগম', 'en' => 'Fatima Begum'],
        'testimonial_2_role' => ['bn' => 'ডিরেক্টর, গ্রীন হোমস', 'en' => 'Director, Green Homes'],
        'testimonial_2_avatar' => ['bn' => 'ফ', 'en' => 'F'],
        'testimonial_3_text' => ['bn' => 'কাস্টমার সার্ভিস অসাম। যেকোনো সমস্যায় ২ ঘণ্টার মধ্যে সমাধান পাই। হাইলি রেকমেন্ড করি।', 'en' => 'Customer service is awesome. Any issue gets resolved within 2 hours. Highly recommend.'],
        'testimonial_3_name' => ['bn' => 'কামাল হাসান', 'en' => 'Kamal Hasan'],
        'testimonial_3_role' => ['bn' => 'CEO, হাসান প্রপার্টিজ', 'en' => 'CEO, Hasan Properties'],
        'testimonial_3_avatar' => ['bn' => 'ক', 'en' => 'K'],

        // FAQ
        'faq_tag'           => ['bn' => 'সচরাচর জিজ্ঞাসা', 'en' => 'FAQ'],
        'faq_title'         => ['bn' => 'প্রশ্ন ও উত্তর', 'en' => 'Questions & Answers'],
        'faq_1_q'           => ['bn' => 'ফ্রি প্ল্যানে কি কোনো লিমিটেশন আছে?', 'en' => 'Are there any limitations on the Free plan?'],
        'faq_1_a'           => ['bn' => 'ফ্রি প্ল্যানে ১টি কোম্পানি, ২টি প্রজেক্ট এবং ৫০টি ইউনিট পর্যন্ত ব্যবহার করতে পারবেন। বেসিক রিপোর্ট এবং টিম ম্যানেজমেন্ট ফিচার অন্তর্ভুক্ত।', 'en' => 'On the Free plan, you can use 1 company, 2 projects, and up to 50 units. Basic reports and team management features are included.'],
        'faq_2_q'           => ['bn' => 'আমি কি পরে প্ল্যান আপগ্রেড করতে পারব?', 'en' => 'Can I upgrade my plan later?'],
        'faq_2_a'           => ['bn' => 'অবশ্যই! যেকোনো সময় Pro বা Enterprise প্ল্যানে আপগ্রেড করতে পারবেন। আপনার ডেটা সম্পূর্ণ সুরক্ষিত থাকবে।', 'en' => 'Absolutely! You can upgrade to Pro or Enterprise at any time. Your data will remain completely safe.'],
        'faq_3_q'           => ['bn' => 'ডেটা কি নিরাপদ?', 'en' => 'Is my data secure?'],
        'faq_3_a'           => ['bn' => 'হ্যাঁ, আমরা SSL এনক্রিপশন, ডেইলি ব্যাকআপ এবং সিকিউর সার্ভার ব্যবহার করি। আপনার ডেটা ১০০% সুরক্ষিত।', 'en' => 'Yes, we use SSL encryption, daily backups, and secure servers. Your data is 100% protected.'],
        'faq_4_q'           => ['bn' => 'মোবাইল থেকে ব্যবহার করা যাবে?', 'en' => 'Can I use it on mobile?'],
        'faq_4_a'           => ['bn' => 'হ্যাঁ! আমাদের সফটওয়্যার সম্পূর্ণ রেসপন্সিভ। যেকোনো ডিভাইস থেকে (মোবাইল, ট্যাবলেট, ডেস্কটপ) ব্যবহার করতে পারবেন।', 'en' => 'Yes! Our software is fully responsive. You can use it from any device (mobile, tablet, desktop).'],
        'faq_5_q'           => ['bn' => 'ট্রায়ালের জন্য ক্রেডিট কার্ড লাগবে?', 'en' => 'Do I need a credit card for the trial?'],
        'faq_5_a'           => ['bn' => 'না, ফ্রি ট্রায়ালের জন্য কোনো ক্রেডিট কার্ড বা পেমেন্ট তথ্য প্রয়োজন নেই। সরাসরি শুরু করুন!', 'en' => 'No, no credit card or payment info is needed for the free trial. Start right away!'],

        // CTA
        'cta_title'         => ['bn' => 'আজই শুরু করুন — সম্পূর্ণ ফ্রি!', 'en' => 'Start Today — Completely Free!'],
        'cta_sub'           => ['bn' => 'হাজার হাজার রিয়েল এস্টেট ব্যবসা ইতোমধ্যে হিসাবিজ ব্যবহার করছে। আপনিও যোগ দিন।', 'en' => 'Thousands of real estate businesses already use Hishabiz. Join them today.'],
        'cta_btn'           => ['bn' => 'ফ্রি অ্যাকাউন্ট তৈরি করুন', 'en' => 'Create Free Account'],

        // Footer
        'footer_desc'       => ['bn' => 'বাংলাদেশের সবচেয়ে সহজ ও শক্তিশালী রিয়েল এস্টেট ম্যানেজমেন্ট সফটওয়্যার।', 'en' => "Bangladesh's easiest and most powerful real estate management software."],
        'footer_product'    => ['bn' => 'পণ্য', 'en' => 'Product'],
        'footer_company'    => ['bn' => 'কোম্পানি', 'en' => 'Company'],
        'footer_support'    => ['bn' => 'সাপোর্ট', 'en' => 'Support'],
        'footer_about'      => ['bn' => 'আমাদের সম্পর্কে', 'en' => 'About Us'],
        'footer_blog'       => ['bn' => 'ব্লগ', 'en' => 'Blog'],
        'footer_careers'    => ['bn' => 'ক্যারিয়ার', 'en' => 'Careers'],
        'footer_contact'    => ['bn' => 'যোগাযোগ', 'en' => 'Contact'],
        'footer_docs'       => ['bn' => 'ডকুমেন্টেশন', 'en' => 'Documentation'],
        'footer_privacy'    => ['bn' => 'প্রাইভেসি পলিসি', 'en' => 'Privacy Policy'],
        'footer_copyright'  => ['bn' => 'হিসাবিজ প্রপার্টি। সর্বস্বত্ব সংরক্ষিত।', 'en' => 'Hishabiz Property. All rights reserved.'],
        'footer_made_in'    => ['bn' => 'বাংলাদেশে ❤️ দিয়ে তৈরি', 'en' => 'Made with ❤️ in Bangladesh'],
    ],
];
